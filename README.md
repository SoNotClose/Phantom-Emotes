# Phantom-Emotes
a private soon to be public and paid emote mod for gorilla tag with over 350+ emotes
...
# Note
as we are developing this mod we try to focus on Fortnite emotes only because that's what the mod was built for
